...
if ("Uniformity of Cell Shape" %in% names(breastcancer_wisconsin) && !all(is.na(breastcancer_wisconsin$`Uniformity of Cell Shape`))) {

  pop_mean <- 10  # Replace this with your actual population mean


  uniformity_cell_shape_ci <- t.test(breastcancer_wisconsin$`Uniformity of Cell Shape`, mu = pop_mean)$conf.int
...
openxlsx::write.xlsx(abalone, "/cloud/project/RWorksheet_Ulgasan#4.xlsx", sheetName = "AbaloneData", rowNames = FALSE)
```
