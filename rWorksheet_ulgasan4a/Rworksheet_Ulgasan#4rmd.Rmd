...
print(new_order_data)
 ...
 #5
import_table <- read.table(file=  "/cloud/project/rWorksheet_ulgasan4a" )
import_table    
...
students = (
    {'name': 'Annie', 'grades': ([88, 95, 92, 85]),
    {'name': 'John', 'grades': [75, 80, 90, 91]),
    {'name': 'Lisa', 'grades': [80, 88, 90, 80]},
    {'name': 'Tim', 'grades': [92, 95, 93, 91]}
)


for student in students:
    highest_score = student['grades'][0]
    
    
    for grade in student['grades'][1:]:
    ...
    if highest_score > 90:
        print(f"{student['name']}'s highest grade this semester is {highest_score}.")
